...
def city_input():
    ...
    print('Hello! I am Harshal! Let\'s explore some US bikeshare data!')
    print(' ')
    ...
    while True:     # for handling the unexpected input by user
            if city == '1' or city == 'chicago':
                print("\nYou have choosen Chicago city! Lets go further..\n")
                return 'chicago'
            if city == '2' or city == 'new york':
                print("\nYou have choosen New York city! Lets go further..\n")
                return 'new york city'
            elif city == '3' or city == 'washington':
                print("\nYou have choosen Washington City! Lets go further..\n")
                return 'washington'
...
def day_freq(df):
    ...
    print('\n The most popular day of the week for bike rides?')
...
def ride_duration(df):
    ...
    print('\n The total traveling done for 2017 through June, and what was the average time spent on each trip?')
...
def gender_data(df):
    ...
    try:
        print('\nThe breakdown of gender among users?\n')
